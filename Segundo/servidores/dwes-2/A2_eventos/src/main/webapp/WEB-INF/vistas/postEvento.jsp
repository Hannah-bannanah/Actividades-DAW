...
<html>
	...
	<body>
		...
		<a class="btn-link" href="/eventos/todos">Volver al listado</a>
		<form action="${ editar ? '/eventos/editar/' : '/eventos/alta' }${ editar ? evento.idEvento : '' }" method="post">
    		<fieldset>
        			...
        			<div class="fieldset-row">
        				<div class="fieldset-column">
        					...
        					<input type="date" name="fechaInicio" id="fechaInicio" 
        						value= "${ editar ? fechaInicio : ''}" required>
        				</div>
        				<div class="fieldset-column">
      			...
      			<fieldset class="form__actions">
      				<input type="text" name="idEvento" id="idEvento" value="${ editar ? evento.idEvento : '0' }" hidden>
