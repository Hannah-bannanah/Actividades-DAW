...
public class Evento implements Serializable{
	...
	public Evento() {
		super();
		this.idEvento = ++ultimoId;
		this.estado = "activo"; //no tiene sentido crear eventos cancelados.
	}
	...
	public Evento(String nombre, String descripcion, 
			Date fechaInicio, int duracion, String direccion, char destacado, int maxAforo, int minAsistencia, 
			double precio, Tipo tipo) {
		super();
		this.idEvento = ++ultimoId;
		this.nombre = nombre;
